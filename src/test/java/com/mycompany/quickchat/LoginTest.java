...
public class LoginTest {
    ...
    String lastname = "Matshaba";
    String username = "_Lese";
    String password = "LesegoLR2@";
    String cellphone = "+27 73137700";
    Login instance = new Login();
    String expResult = "Cellphone is not correctly formatted or does not contain international code.\n";  // Expected result (you can change this according to your business logic)
